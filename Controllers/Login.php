        ...
        if(empty($_POST['txtEmailReset'])){
            ...
            if(empty($arrData)){
                ...
                if($requestUpdate){
                    ...
                    if($sendEmail){
                        $arrResponse = ['status' => true, 'msg' => 'Correo enviado'];
                    }else{
                        $arrResponse = ['status' => false, 'msg' => 'Error al enviar el correo'];
                    }
                }else{
                    $arrResponse = ['status' => false, 'msg' => 'Error al actualizar token'];
                }
            }
        }
		ob_clean();
