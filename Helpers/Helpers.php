...
function sendEmail($data, $template)
{
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'soportestuntriders@gmail.com';     // 👉 tu correo Gmail
        ...
        //$mail->addAddress("tiagovalbuenacabadia@gmail.com");
        ...
        // 🔎 Devuelve error más detallado para depuración
        return ["status" => false, "msg" => "Error al enviar el correo: {$mail->ErrorInfo}"];
    }
}
...
/*function sendMailLocal($data, $template)
{
    ...
    try {
        ...
        $mail->Username   = 'soportestuntriders@gmail.com';                     //SMTP username
        $mail->Password   = 'mkme jgrz nenm zglh';                               //SMTP password
